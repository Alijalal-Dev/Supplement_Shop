    ...
    <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
        ...
        <symbol xmlns="http://www.w3.org/2000/svg" id="bicycling-round-outline" viewBox="0 0 24 24">
            <path fill="currentColor" fill-rule="evenodd"
                d="M14 2.75a1.25 1.25 0 1 0 0 2.5a1.25 1.25 0 0 0 0-2.5M11.25 4a2.75 2.75 0 1 1 5.5 0a2.75 2.75 0 0 1-5.5 0m-.331 4.506a1.888 1.888 0 1 0-1.93 3.207l3.09 1.349a2.64 2.64 0 0 1 1.37 3.46l-.76 1.773a.75.75 0 0 1-1.378-.59l.76-1.775a1.14 1.14 0 0 0-.592-1.494l-3.09-1.348a3.388 3.388 0 1 1 3.464-5.756l2.159 1.719a.915.915 0 0 0 .57.199H18.5a.75.75 0 0 1 0 1.5h-3.918a2.417 2.417 0 0 1-1.505-.526zM6 15.75a2.25 2.25 0 1 0 0 4.5a2.25 2.25 0 0 0 0-4.5M2.25 18a3.75 3.75 0 1 1 7.5 0a3.75 3.75 0 0 1-7.5 0M18 15.75a2.25 2.25 0 1 0 0 4.5a2.25 2.25 0 0 0 0-4.5M14.25 18a3.75 3.75 0 1 1 7.5 0a3.75 3.75 0 0 1-7.5 0"
                clip-rule="evenodd" />
        </symbol>
        ...
        <symbol xmlns="http://www.w3.org/2000/svg" id="play" width="4em" height="4em"
            viewBox="0 0 32 32">
            <path fill="currentColor"
                d="M9 5.156v21.688l1.531-1L25.844 16L10.53 6.156zm2 3.657L22.156 16L11 23.188z" />
        </symbol>
                                        ...
                                        <li>
                                            <form method="POST" action="{{ route('logout') }}">
                                                ...
                                                <button type="submit" class="dropdown-item text-uppercase"
                                                    style="color: var(--bs-link-color);">Logout</button>
                                            </form>
                                        </li>
                                        <li>
                                            <a href="{{ route('dashboard') }}" class="dropdown-item text-uppercase"
                                                style="color: var(--bs-link-color);">Dashboard</a>
                                    </ul>
                                </li>
                            @endauth
                        </ul>
    ...
    <section id="home" class="section-padding">
        <div class="container">
            <div class="row g-3 flex-row-reverse align-items-center">
                <div class="col-md-6">
                    <img src="images/supple1.jpg" class="img-fluid rounded-4"
                        style="height: 600px;margin-left: 100px" alt="banner">
                </div>
                <div class="col-md-6 text-center">
                    ...
                    <a href="#features"
                        class="btn btn-primary text-uppercase px-5 py-3 text-dark fw-semibold rounded-pill mt-4">Discover
                        us</a>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-4 mt-3">
                    ...
                    <div class="d-flex gap-4 flex-md-row-reverse mb-5 me-2">
                        ...
                        <div class="text-md-end">
                            <h4>Bone Health</h4>
                            <p>Strengthen your bones with key vitamins like calcium and vitamin D for long-term support
                                and mobility.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <img src="images/feature_img.png" class="img-fluid rounded-4"
                ...
                <div class="col-md-4 mt-3">
                    ...
                    <div class="col">
                        <div class="d-flex gap-4 mb-5 ms-2">
                            ...
                            <div class="text-start">
                                <h4>Great Taste</h4>
                                <p>Enjoy the benefits of supplements without the chalky aftertaste delicious flavors
                                    make health a treat.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="d-flex gap-4 mb-5 ms-2">
                            ...
                            <div class="text-start">
                                ...
                                <p>Boost your energy during training to get the most out of your weightlifting sessions.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion" id="accordionExample">
                        ...
                        <div class="accordion-item rounded-0 mb-3">
                            <h3 class="accordion-header">
                                <button class="accordion-button text-capitalize fw-semibold" type="button"
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show"
                                ...
                                <div class="accordion-body">
                                    <p>We offer a wide range of supplements, including vitamins, minerals, protein
                                        powders, pre-workouts, and wellness supplements for immunity, energy, and
                                        overall health.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item rounded-0 mb-3">
                            <h3 class="accordion-header">
                                <button class="accordion-button text-capitalize fw-semibold collapsed" type="button"
                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <p>Yes! Our supplements are made with high-quality ingredients and follow strict
                                        safety standards. However, we recommend consulting a healthcare professional
                                        before use.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item rounded-0 mb-3">
                            ...
                            <div id="collapseThree" class="accordion-collapse collapse"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <p>Shipping times vary based on location. Typically, orders are delivered within 1
                                        day if it's the same city; otherwise, it may take 2 to 3 days.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item rounded-0 mb-3">
                            ...
                            <div id="collapseFour" class="accordion-collapse collapse"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <p>Keep supplements in a cool, dry place, away from direct sunlight. Some products
                                        may require refrigeration—check the packaging for details.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item rounded-0 mb-3">
                            ...
                            <div id="collapseFive" class="accordion-collapse collapse"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <p>Yes! We offer free shipping on orders over 800 DHS. Check our shipping policy for
                                        details.</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-3">
                    ...
                    <form id="form" action="{{ route('testimonial.store') }}" method="POST"
                        ...
                        <div class="w-100 d-flex gap-3">
                            ...
                            <div class="w-100">
                                <input type="email" name="email" placeholder="Email*" class="form-control w-100"
                                    required>
                            </div>
                            <div class="w-100">
                        ...
                        <div class="w-100">
                            <input type="text" name="message" placeholder="Question*" class="form-control w-100"
                                required>
                        </div>
                        <button type="submit"
                            class="btn btn-primary text-uppercase px-5 py-3 text-dark fw-semibold rounded-pill mt-4">Send</button>
                    </form>
                </div>
            </div>
        </div>
